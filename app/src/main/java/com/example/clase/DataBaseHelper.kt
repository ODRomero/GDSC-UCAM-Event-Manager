...
class DataBaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    companion object {
        ...
        const val DATABASE_NAME = "MySQLDataBase1"
    }
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val tablas2 = arrayOf(
            ...
            "insert into Evento (nombre, fecha, descripcion, foto, FID, UBID) values('Taller Python Basico', 'Oct 15, 2022', 'Introduccion al lenguaje de progracion Python', 'https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_xy_center,h_650,q_auto:good,w_1200,x_w_mul_0.5,y_h_mul_0.65/v1/gcs/platform-data-dsc/event_banners/promo%20taller%20basico%20de%20python.png', '2', '2')",
            "insert into Evento (nombre, fecha, descripcion, foto, FID, UBID) values('Taller GitHub Basico', 'Oct 11, 2022', 'Introduccion al control de versiones con Github', 'https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_xy_center,h_650,q_auto:good,w_1200,x_w_mul_0.5,y_h_mul_0.55/v1/gcs/platform-data-dsc/event_banners/GitHub%20Basico%20Promo%20-%20Green.jpg', '3', '3')",
            "insert into Evento (nombre, fecha, descripcion, foto, FID, UBID) values('Charla Pollitos', 'Oct 7, 2022', 'Charla de estudiantes de 3ro y 4to para los de nuevo ingreso', 'https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_xy_center,h_650,q_auto:good,w_1440,x_w_mul_0.5,y_h_mul_0.56/v1/gcs/platform-data-dsc/event_banners/_Charla%20pollitos%20Event%20Promo%20-%20Red.png?md', '4', '3')",
            "insert into Evento (nombre, fecha, descripcion, foto, FID, UBID) values('Taller Refuerzo C', 'Oct 25, 2022', 'Taller de refuerzo del lenguaje de progracion C para estudiantes de Programacion I', 'https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_xy_center,h_650,q_auto:good,w_1440,x_w_mul_0.5,y_h_mul_0.0/v1/gcs/platform-data-dsc/event_banners/promo%20refuerzo%20c%201%20%281%29.png?md', '5', '3')",
            "insert into Evento (nombre, fecha, descripcion, foto, FID, UBID) values('Taller GitHub Intermedio', 'Oct 18, 2022', 'Taller sobre el manejo de Git y GitHub via la CLI', 'https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_xy_center,h_650,q_auto:good,w_1440,x_w_mul_0.5,y_h_mul_0.77/v1/gcs/platform-data-dsc/event_banners/Git_session.svg.png?md', '4', '2')",
            "insert into Evento (nombre, fecha, descripcion, foto, FID, UBID) values('Taller Refuerzo Java', 'Oct 28, 2022', 'Taller de refuerzo del lenguaje de progracion Java para estudiantes de Programacion Orientada a Objetos', 'https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_xy_center,h_650,q_auto:good,w_1440,x_w_mul_0.5,y_h_mul_0.0/v1/gcs/platform-data-dsc/event_banners/promo%20refuerzo%20java%201.png?md', '6', '1')",
